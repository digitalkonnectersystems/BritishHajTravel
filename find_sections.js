const fs = require('fs');
const content = fs.readFileSync('e:/WordPress Plugins/DKS Projects/king-travel-can-nxt/src/app/page.tsx', 'utf-8');
...
console.log('Types mentioned in page.tsx:', Array.from(mappedTypes));
