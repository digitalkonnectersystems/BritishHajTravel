...
const defaultReviews: Review[] = [
  ...
  },
  {
    ...
    text: "We’re so glad we booked our Umrah trip from British Hajj Travel. Mr. Jamil Latif provided exceptional service, from the initial booking, he reassured us that everything would go smoothly, and he delivered exactly that. His professionalism, clear communication made the entire process stress‑free. The agency also offered excellent arrangements and reliable support throughout. Highly recommended!",
  },
  {
    id: 4,
    name: "Dina",
  ...
  },
  {
    ...
    text: "I am grateful Elhamdullilahi for this wonderful opportunity to preform Umrah on March 2026 with British Hajj Travel, also with huge support from our Imam Ismail Fetic which this journey wouldn't be possible without his guidance.",
  },
  {
    id: 6,
