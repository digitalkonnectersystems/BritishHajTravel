...
export default function EconomyHajj2027Page() {
  ...
  const getEstimatedTotal = () => {
    ...
    return (12995 * guestNum).toLocaleString();
  };
      ...
      <div className="sub-header bg-[#0b4a3a] text-white py-12 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="hero-info">
            <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-3">Economy Hajj Package 2027</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 flex flex-col hover:-translate-y-1 transition duration-200">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <h4 className="font-bold text-lg text-slate-900 mb-1">5 Star Luxury Hotel</h4>
              ...
              <div className="relative pl-8 border-l-2 border-dashed border-slate-300 ml-4 space-y-8">
                ...
                <div className="relative">
                  ...
                  <h4 className="font-bold text-lg text-slate-900 mb-2">
                    DURING STAY AT MADINAH <span className="text-xs text-slate-500 font-normal">- Hotel close to Haram (Breakfast &amp; Dinner)</span>
                  </h4>
                  <ul className="space-y-2 text-sm text-slate-600">
                    <li><strong className="text-slate-800 font-semibold">01 Dhul-Hajjah:</strong> Check in at Madinah hotel and spend time in Prophet's Mosque</li>
                    ...
                    <li><strong className="text-slate-800 font-semibold">04 Dhul-Hajjah:</strong> Checkout from Madinah and Leave for Makkah Aziziya by air-conditioned coach</li>
                  </ul>
                </div>
                ...
                <div className="relative">
                  ...
                  <ul className="space-y-2 text-sm text-slate-600">
                    <li><strong className="text-slate-800 font-semibold">04 – 07 Dhul-Hajjah:</strong> Stay at Aziziya Accommodation.</li>
                  </ul>
                </div>
                ...
                <div className="relative">
                  <div className="absolute -left-[41px] top-1 w-5 h-5 rounded-full bg-white border-4 border-[#d4af37]"></div>
                  <h4 className="font-bold text-lg text-slate-900 mb-2">
                    DURING STAY AT MINA <span className="text-xs text-slate-500 font-normal">- Near Jamarat Maktab-A-Category (Full Board)</span>
                  </h4>
                  <ul className="space-y-2 text-sm text-slate-600">
                    <li><strong className="text-slate-800 font-semibold">07 – 12 Dhul-Hajjah:</strong> Rituals at Mina / Arafaat / Muzalfa.</li>
                  </ul>
                </div>
                ...
                <div className="relative">
                  <div className="absolute -left-[41px] top-1 w-5 h-5 rounded-full bg-white border-4 border-[#d4af37]"></div>
                  <h4 className="font-bold text-lg text-slate-900 mb-2">
                    DURING STAY AT AZIZIYA <span className="text-xs text-slate-500 font-normal">- Hotel - Maktab-A-Category (Full Board)</span>
                  </h4>
                  <ul className="space-y-2 text-sm text-slate-600">
                    <li><strong className="text-slate-800 font-semibold">12 to 14 Dhul-Hajjah:</strong> Stay and preparation for departure.</li>
            ...
            <div className="sticky top-28 bg-white rounded-3xl p-6 shadow-xl border border-slate-100 space-y-6">
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="flex justify-between items-center py-1">
                  ...
                  <span className="text-2xl font-bold text-red">£ {getEstimatedTotal()}</span>
                </div>
