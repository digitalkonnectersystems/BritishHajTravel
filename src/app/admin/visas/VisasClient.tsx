...
export default function VisasClient({ initialVisas }: VisasClientProps) {
  ...
  const [newVisa, setNewVisa] = useState({
    ...
    shortDescription: '',
    fullDescription: '',
    requirements: 'British Passport, Digital Photo',
  });
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-200/60 pb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="bg-primary hover:bg-white hover:text-primary text-white px-5 py-2.5 rounded-full text-xs font-extrabold transition-colors cursor-pointer border-none shadow-md flex items-center gap-2"
          >
